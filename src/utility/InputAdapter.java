...
/**
 * <p>
 * an abstract adapter class for {@link KeyEvent}, {@link MouseEvent} and
 * {@link TouchEvent} events. when extending this class only override methods
 * that are needed. register method for those event methods must also be called.
 * 
 * <pre>
...
public class InputAdapter {
	...
	/**
	 * <p>
	 * add the given {@link EventHandler} with {@link EventType} to given
	 * {@link InputAdapter#node}.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * remove the given {@link EventHandler} registered with {@link EventType} on
	 * given {@link InputAdapter#node}.
	 * </p>
	 * 
	 * @param event   - an event such as {@link MouseEvent#MOUSE_MOVED}.
	 * @param handler - a lambda to be used when registered event is triggered.
	...
	/**
	 * <p>
	 * when the mouse enters the area of given {@link InputAdapter#node} in
	 * constructor, {@link MouseEvent#MOUSE_ENTERED} is triggered and subsequently
	 * {@link Node#requestFocus()} is called to force focus if
	 * {@link InputAdapter#node} is eligible.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * add {@link MouseEvent#MOUSE_MOVED} and {@link MouseEvent#MOUSE_DRAGGED} event
	 * handlers to given {@link InputAdapter#node}.
	 * </p>
	 * 
	 * @param move - lambda or method reference which takes one argument. to be
	 *             called when mouse moves
	 * @param drag - lambda or method reference which takes one argument. to be
	...
	/**
	 * <p>
	 * remove {@link MouseEvent#MOUSE_MOVED} and {@link MouseEvent#MOUSE_DRAGGED}
	...
	/**
	 * <p>
	 * add {@link MouseEvent#MOUSE_ENTERED_TARGET} and
	 * {@link MouseEvent#MOUSE_EXITED_TARGET} event handlers to given
	 * {@link InputAdapter#node}.
	 * </p>
	 * 
	 * @param move - lambda or method reference which takes one argument. to be
	 *             called when mouse enters target
	 * @param drag - lambda or method reference which takes one argument. to be
	...
	/**
	 * <p>
	 * remove {@link MouseEvent#MOUSE_ENTERED_TARGET} and
	 * {@link MouseEvent#MOUSE_EXITED_TARGET} event handlers from given
	 * {@link InputAdapter#node}.
	 * </p>
	 * 
	 * @param move - lambda or method reference which takes one argument. to be
	...
	/**
	 * <p>
	 * add {@link MouseEvent#MOUSE_PRESSED} and {@link MouseEvent#MOUSE_RELEASED}
	 * event handlers to given {@link InputAdapter#node}.
	 * </p>
	 * 
	 * @param pressed  - lambda or method reference which takes one argument. to be
	 *                 called when mouse is pressed
	 * @param released - lambda or method reference which takes one argument. to be
	...
	/**
	 * <p>
	 * remove {@link MouseEvent#MOUSE_PRESSED} and {@link MouseEvent#MOUSE_RELEASED}
	 * event handlers from given {@link InputAdapter#node}.
	 * </p>
	 * 
	 * @param pressed  - lambda or method reference which takes one argument. to be
	...
	/**
	 * <p>
	 * add {@link MouseEvent#MOUSE_PRESSED},{@link MouseEvent#MOUSE_DRAGGED} and
	 * {@link MouseEvent#MOUSE_RELEASED} event handlers to given
	 * {@link InputAdapter#node}.
	 * </p>
	 * 
	 * @param pressed  - lambda or method reference which takes one argument. to be
	 *                 called when screen is touched
	 * @param dragged  - lambda or method reference which takes one argument. to be
	 *                 called when screen is dragged
	 * @param released - lambda or method reference which takes one argument. to be
	 *                 called when screen is released
	 */
	public void registerMouseClick(EventHandler<TouchEvent> pressed, EventHandler<TouchEvent> dragged,
			EventHandler<TouchEvent> released) {
		if (pressed != null)
	...
	/**
	 * <p>
	 * remove {@link TouchEvent#TOUCH_PRESSED}, {@link TouchEvent#TOUCH_MOVED} and
	 * {@link TouchEvent#TOUCH_RELEASED} event handlers from given
	 * {@link InputAdapter#node}.
	 * </p>
	 * 
	 * @param pressed  - lambda or method reference which takes one argument. to be
	 ...
	 *                 called when screen is released
	 */
	public void removeTouch(EventHandler<TouchEvent> pressed, EventHandler<TouchEvent> dragged,
			EventHandler<TouchEvent> released) {
		if (pressed != null)
	...
	/**
	 * <p>
	 * add {@link KeyEvent#KEY_PRESSED} and {@link KeyEvent#KEY_RELEASED} event
	 * handlers to given {@link InputAdapter#node}. for full functionality
	 * {@link InputAdapter#forceFocusWhenMouseEnters} should be called as
	 * {@link KeyEvent} needs focus.
	 * </p>
	 * 
	 * @param pressed  - lambda or method reference which takes one argument. to be
	...
	/**
	 * <p>
	 * remove {@link KeyEvent#KEY_PRESSED} and {@link KeyEvent#KEY_RELEASED} event
	 * handlers from given {@link InputAdapter#node}.
	 * </p>
	 * 
	 * @param pressed  - lambda or method reference which takes one argument. to be
	 *                 called when key is pressed
